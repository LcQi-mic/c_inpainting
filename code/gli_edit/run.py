...
parser.add_argument("--dice_lambda", default=0.70, type=float)
...
# Model
parser.add_argument("--in_c", default=3, type=int)
parser.add_argument("--filters", default=16, type=int)
parser.add_argument("--style_dim", default=512, type=int)
parser.add_argument("--out_c", default=3, type=int)
